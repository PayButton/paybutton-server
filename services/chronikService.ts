...
export class ChronikBlockchainClient {
  ...
  private async chronikCallWithRetry<T> (
    label: string,
    fn: () => Promise<T>,
    tries = CHRONIK_HTTP_MAX_RETRIES,
