...
-- CreateTable
CREATE TABLE `PaybuttonAddressOnPaybutton` (
    `paybuttonId` INTEGER NOT NULL,
    `paybuttonAddressId` INTEGER NOT NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,

    PRIMARY KEY (`paybuttonId`, `paybuttonAddressId`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `PaybuttonAddressOnPaybutton` ADD CONSTRAINT `PaybuttonAddressOnPaybutton_paybuttonAddressId_fkey` FOREIGN KEY (`paybuttonAddressId`) REFERENCES `PaybuttonAddress`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `PaybuttonAddressOnPaybutton` ADD CONSTRAINT `PaybuttonAddressOnPaybutton_paybuttonId_fkey` FOREIGN KEY (`paybuttonId`) REFERENCES `Paybutton`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
