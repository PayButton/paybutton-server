export const createDevUsersRawQueryList = [
  ...
  'INSERT INTO app_id_to_user_id VALUES (\'public\', \'dev3-uid\', \'dev3-uid\', 0, \'emailpassword\') ON DUPLICATE KEY UPDATE user_id=user_id;',
  'INSERT INTO emailpassword_users VALUES (\'public\', \'dev3-uid\', \'dev3@paybutton.org\', \'$2a$11$AGppTnFU3HBeHuH1z3kPb.A1WFUxHVVNmAmiMaHJ3QvVkWT58jxBO\', 1652220489244) ON DUPLICATE KEY UPDATE user_id=user_id;',
  'INSERT INTO emailverification_verified_emails VALUES (\'public\', \'dev3-uid\', \'dev3@paybutton.org\') ON DUPLICATE KEY UPDATE user_id=user_id;',
  'INSERT INTO all_auth_recipe_users VALUES (\'public\', \'public\', \'dev3-uid\', \'dev3-uid\', 0, \'emailpassword\', 1652220489244, 1652220489244) ON DUPLICATE KEY UPDATE user_id=user_id;',
  'INSERT INTO emailpassword_user_to_tenant VALUES (\'public\', \'public\', \'dev3-uid\', \'dev3@paybutton.org\') ON DUPLICATE KEY UPDATE user_id=user_id;'
...
export const adminUserProfiles = [
  {
    ...
    isAdmin: true,
    publicKey: '',
    emailCredits: 10000000,
    postCredits: 10000000
  }
]
